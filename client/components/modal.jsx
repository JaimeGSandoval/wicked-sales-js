...
class Modal extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.currentView === 'checkout') {
      this.messageToUser = 'Important Notice: Please Do Not Enter Any Personal or Highly Sensitive Information When Filling Out The Form. It Is For Demonstration Purposes Only.';
    } else {
